...
const DATA_PUBLICATIONS = [
  ...
  year:     2026,
  paperLink:"https://papers.ssrn.com/sol3/papers.cfm?abstract_id=7322879",
...

 {
    ...
    venue:    "Published in Discover Artificial Intelligence",
    year:     2026,
    paperLink:"https://link.springer.com/article/10.1007/s44163-026-01983-w",
    image:    "nlp.jpg",
  ...
  { title: "Unleashing Generative Artificial Intelligence (GenAI) in Scientific Research: A Hybrid LBWA-WASPAS-DEMATEL Decision Framework", authors: [ "Md. Limonur Rahman Lingkon", "Rupok Islam Avi", "Md. Hasin Arman", "Chitra Lekha Karmaker", "Syed Mithun Ali" ], venue: "Under Review in The International Journal of Information Management Data Insights (Elsevier)", year: 2026, paperLink: "", image: "GenAI_research.png", abstract: "The rapid adoption of Generative Artificial Intelligence (GenAI) is reshaping scientific research by enhancing the efficiency of literature reviews, academic writing, data analysis, and hypothesis generation. Alongside these benefits, it faces growing concerns related to misinformation, ethical ambiguity, transparency deficits, skill erosion, and inequitable access. Although preliminary guidelines have been introduced, current regulatory and operational frameworks remain fragmented, discipline-specific, and insufficient to ensure responsible and consistent GenAI use in scientific research. Existing studies predominantly focus on the opportunities and ethical implications of GenAI or provide qualitative discussions of its risks. However, there is a clear research gap in systematically identifying, quantifying, and prioritizing the key barriers to the ethical and effective integration of GenAI, particularly by accounting for the interdependencies among these barriers. Moreover, the absence of data-driven decision frameworks limits evidence-based policy formulation and strategic intervention. To address these gaps, this study proposes a hybrid multi-criteria decision-making (MCDM) framework integrating Level-Based Weight Assessment and Weighted Aggregated Sum Product Assessment to weight and rank barriers to responsible GenAI use in scientific research. Thirteen impacts, derived from literature and expert evaluation, are analyzed to identify six critical barriers. The robustness of the ranking is validated through sensitivity and comparative analyses, demonstrating strong correlation stability exceeding 0.98. Furthermore, a Decision-Making Trial and Evaluation Laboratory analysis reveals weak data governance and insufficient researcher training as dominant causal barriers, while transparency, validation, and equity emerge as dependent effects. The proposed framework offers actionable insights for policymakers and academic institutions seeking ethical, transparent, and inclusive adoption of GenAI." },

{
  title:    "Sustainable Resource-constrained Project Scheduling and Material Ordering Problem with Discounted Cash Flows",
  authors:  ["Md. Limonur Rahman Lingkon", "Md. Asadujjaman", "Rupok Islam Avi"],
  venue:    "3rd International Conference on Mechanical, Manufacturing and Process Engineering (ICMMPE – 2026)",
  year:     2026,
  paperLink:"",
  image:    "scheduling.jpg",
  abstract: "This paper introduces a sustainable resource-constrained project scheduling and material ordering problem with discounted cash flows (SRCPS-MOP-DC) model. The model integrates activity scheduling and renewable resource distribution with supplier selection, inventory, and carbon-emission costs into a single optimization framework. In contrast to conventional scheduling frameworks, the model explicitly accounts for carbon emissions from material transportation, supplier activities, warehousing, and project activities, enabling project managers to assess both financial and environmental performance. To address the problem, a multi-operator genetic algorithm (MOGA) is applied, incorporating multiple crossover and mutation operators, tournament selection, repair feasibility, and elitist replacement to ensure solution quality and search diversity. Numerical modeling of construction project data reveals that the model can produce viable activity schedules, optimal order schedules, and efficient inventory flows without violating carbon-emission limits. Inventory and supplier decisions are found to have a significant impact on project profitability, and sensitivity analysis shows that inventory holding cost is the most influential parameter. The proposed model achieved an optimal net present value (NPV) of 498.73, demonstrating the effectiveness of integrating sustainability considerations into project scheduling and material ordering decisions.",
},
  {
